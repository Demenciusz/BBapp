...
class CharacterStats extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        Expanded(
          child: BlocBuilder<CharactersStatsCubit, CharactersState>(
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return CharacterRow(
                      ...
                      fun: () => BlocProvider.of<CharactersStatsCubit>(context)
        ...
        GestureDetector(
          onTap: () {
            bool b = BlocProvider.of<CharactersStatsCubit>(context)

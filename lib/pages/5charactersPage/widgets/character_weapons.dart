...
class CharacterWeapons extends StatelessWidget {
  CharacterWeapons({super.key});
      ...
      children: [
        Expanded(
          child: Padding(
            ...
            child: BlocBuilder<CharactersWeaponsCubit, CharactersState>(
                  ...
                  return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return CharacterRow(
                        ...
                        fun: () => BlocProvider.of<CharactersWeaponsCubit>(
                                context)

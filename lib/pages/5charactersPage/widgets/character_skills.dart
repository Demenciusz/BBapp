...
class CharacterSkils extends StatelessWidget {
  CharacterSkils({super.key});
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        Expanded(
          child: BlocBuilder<CharactersSkillsCubit, CharactersState>(
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return CharacterRow(
                      ...
                      fun: () => BlocProvider.of<CharactersSkillsCubit>(context)
